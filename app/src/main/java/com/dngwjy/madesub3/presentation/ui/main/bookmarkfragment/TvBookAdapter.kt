 ...
 */
class TvBookAdapter(val data: List<TvLocal>, val listener: (TvLocal) -> Unit) :
    RecyclerView.Adapter<TvBookAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView), LayoutContainer {
        ...
        fun bindData(item: TvLocal, listen: (TvLocal) -> Unit) {
